...
const MODULE_PAGES = {
  ...
  infecto: [
    ...
    {id:'mdr',         file:'mdr.html',         cat:'Ler a resistência',            label:'Multirresistentes',                 title:'Os multirresistentes: Pseudomonas, Acinetobacter e Enterococos', subtitle:'Não-fermentadores e enterococos resistentes: quando usar as novas beta-lactamases e o cefiderocol'},
    {id:'pneumonia',   file:'pneumonia.html',   cat:'Cenários por foco',            label:'Pneumonia',                         title:'Pneumonia na UTI: CAP grave, HAP e PAV',                         subtitle:'Terapia empírica, procalcitonina e o tempo certo de tratamento'},
    {id:'abdome',      file:'abdome.html',      cat:'Cenários por foco',            label:'Abdome e vias biliares',            title:'Infecção intra-abdominal e das vias biliares',                   subtitle:'Controle de foco, comunitária versus nosocomial, colangite, colecistite e peritonite bacteriana espontânea'},
    {id:'urinario',    file:'urinario.html',    cat:'Cenários por foco',            label:'Urossepse e ITU',                   title:'Urossepse e ITU complicada',                                     subtitle:'Pielonefrite grave, ITU associada a cateter e a fonte urinária de sepse no paciente crítico'},
    {id:'partesmoles', file:'partesmoles.html', cat:'Cenários por foco',            label:'Pele e partes moles',               title:'Pele e partes moles graves',                                     subtitle:'Fasceíte necrotizante, pé diabético grave e infecção de sítio cirúrgico'},
    {id:'snc',         file:'snc.html',         cat:'Cenários por foco',            label:'Sistema nervoso central',           title:'Infecções do sistema nervoso central',                           subtitle:'Meningite bacteriana, encefalite herpética e abscesso cerebral: a escolha do antimicrobiano'},
    {id:'bacteremia',  file:'bacteremia.html',  cat:'Cenários por foco',            label:'Bacteremia, cateter e endocardite', title:'Bacteremia, infecção de cateter e endocardite',                  subtitle:'Terapia empírica adequada, CLABSI, hemoculturas de controle, duração e endocardite'},
    {id:'candidemia',  file:'candidemia.html',  cat:'Cenários por foco',            label:'Candidemia',                        title:'Candidemia e candidíase invasiva',                               subtitle:'Quando suspeitar, equinocandina como primeira linha, fundo de olho e duração'},
  ...
  prescricoes: [
    ...
    {id:'hiponatremia',                file:'hiponatremia.html',                cat:'Hidroeletrolítico', label:'Hiponatremia',                       title:'Prescrição comentada — Hiponatremia',                         subtitle:'Sintomático leva NaCl 3% em bolus; o resto é ritmo — e o teto de 8 mEq/L em 24 h'},
    {id:'hipernatremia',               file:'hipernatremia.html',               cat:'Hidroeletrolítico', label:'Hipernatremia',                      title:'Prescrição comentada — Hipernatremia',                        subtitle:'Água livre calculada, déficit reposto devagar — e a causa quase sempre é acesso à água'},
    {id:'hipocalemia',                 file:'hipocalemia.html',                 cat:'Hidroeletrolítico', label:'Hipocalemia',                        title:'Prescrição comentada — Hipocalemia',                          subtitle:'Reposição pela via certa: teto de 40 mEq/L e 10 mEq/h no periférico — e o magnésio junto'},
    {id:'hipercalemia',                file:'hipercalemia.html',                cat:'Hidroeletrolítico', label:'Hipercalemia',                       title:'Prescrição comentada — Hipercalemia',                         subtitle:'Cálcio protege a membrana, insulina joga o K para dentro, e só a diálise tira do corpo'},
    {id:'hipocalcemia',                file:'hipocalcemia.html',                cat:'Hidroeletrolítico', label:'Hipocalcemia',                       title:'Prescrição comentada — Hipocalcemia',                         subtitle:'Cálcio iônico antes de tratar, gluconato no periférico — e o magnésio que ninguém dosa'},
    {id:'hipomagnesemia',              file:'hipomagnesemia.html',              cat:'Hidroeletrolítico', label:'Hipomagnesemia',                     title:'Prescrição comentada — Hipomagnesemia',                       subtitle:'A deficiência que sustenta hipocalemia e hipocalcemia refratárias — e o rim que joga fora'},
    {id:'hipofosfatemia',              file:'hipofosfatemia.html',              cat:'Hidroeletrolítico', label:'Hipofosfatemia',                     title:'Prescrição comentada — Hipofosfatemia',                       subtitle:'Quando repor de verdade, e por que quem manda na velocidade é o potássio da ampola'},
    {id:'cetoacidose-diabetica',       file:'cetoacidose-diabetica.html',       cat:'Endócrino',         label:'Cetoacidose diabética',              title:'Prescrição comentada — Cetoacidose diabética',                subtitle:'Fluido, potássio antes da insulina e cetose como alvo — a glicemia normaliza antes de a crise terminar'},
    {id:'estado-hiperosmolar',         file:'estado-hiperosmolar.html',         cat:'Endócrino',         label:'Estado hiperosmolar hiperglicêmico', title:'Prescrição comentada — Estado hiperosmolar hiperglicêmico',   subtitle:'Corrigir volume e osmolalidade sem pressa — o cérebro importa mais que o número da glicose'},
    {id:'hda',                         file:'hda.html',                         cat:'Gastro',            label:'Hemorragia digestiva alta',          title:'Prescrição comentada — Hemorragia digestiva alta',            subtitle:'Ressuscitar, reconhecer o ramo varicoso e chegar à endoscopia com a medicação certa'},
    {id:'pancreatite-aguda',           file:'pancreatite-aguda.html',           cat:'Gastro',            label:'Pancreatite aguda',                  title:'Prescrição comentada — Pancreatite aguda',                    subtitle:'Hidratação moderada, analgesia, alimentação precoce e nenhum antibiótico para necrose estéril'},
    {id:'asma-aguda',                  file:'asma-aguda.html',                  cat:'Pneumo',            label:'Exacerbação grave de asma',          title:'Prescrição comentada — Exacerbação grave de asma',            subtitle:'Broncodilatador repetido, corticoide precoce e magnésio só no grave — alta nunca com SABA isolado'},
    {id:'dpoc-exacerbacao',            file:'dpoc-exacerbacao.html',            cat:'Pneumo',            label:'Exacerbação aguda de DPOC',          title:'Prescrição comentada — Exacerbação aguda de DPOC',            subtitle:'Oxigênio controlado, broncodilatadores, cinco dias de corticoide e antibiótico só quando indicado'},
    {id:'anafilaxia',                  file:'anafilaxia.html',                  cat:'Alergia',           label:'Anafilaxia',                         title:'Prescrição comentada — Anafilaxia',                           subtitle:'Adrenalina IM primeiro e repetida cedo — anti-histamínico não trata via aérea nem choque'},
    {id:'pneumonia-comunitaria-grave', file:'pneumonia-comunitaria-grave.html', cat:'Infecção',          label:'Pneumonia comunitária grave',        title:'Prescrição comentada — Pneumonia comunitária grave',          subtitle:'Beta-lactâmico com atípicos, microbiologia para desescalar e ampliação só com risco validado'},
    {id:'meningite-bacteriana',        file:'meningite-bacteriana.html',        cat:'Infecção',          label:'Meningite bacteriana aguda',         title:'Prescrição comentada — Meningite bacteriana aguda',           subtitle:'Antibiótico e dexametasona sem esperar a tomografia — dose meníngea e Listeria por risco'},
  ],
  institucional: [
